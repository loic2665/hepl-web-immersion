...
export function ajouter(tableau){
    ...
    requeteAjax.requeteAjax("POST", "/admin/api/gererTranches_horaires.php", tableau, "json", successCallback, null, null);
}
...
export function initForm(){
    ...
    inputs = $('input[type=number]');                       // on récupere les differents types d'input text du formulaire
    for( let input of inputs){                                // boucle pour remplir les champs texte
        input.value = "";
    }
}
