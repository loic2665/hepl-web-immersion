...
export function ajouter(tableau){
    ...
    requeteAjax.requeteAjax("POST", "/admin/api/gererCours.php", tableau, "json", successCallback, null, null);
}
...
export function initForm(){
    ...
    inputs = $('input[type=number]');                          // on récupere les differents types d'input radio du formulaire
